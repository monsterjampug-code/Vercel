...
async function createEndorsement(formData: FormData) {
  "use server"
  ...
  await adminSupabase.from("endorsements").insert({
    name,
    job_title,
    quote,
...
export default async function CreateEndorsementPage() {
      ...
      <header className="bg-gradient-to-r from-amber-600 to-amber-700 text-white shadow-lg">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">Create Endorsement</h1>
          ...
          <CardContent>
            <form action={createEndorsement} className="space-y-4">
              ...
              <div>
                ...
                <Input id="job_title" name="job_title" required placeholder="Museum Curator" />
              </div>
